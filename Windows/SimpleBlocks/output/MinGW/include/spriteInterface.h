...
class SpriteInterface{
 public:
  ...
  virtual void left(double Dangle, bool repaintP=true)=0;
  virtual void right(double Dangle, bool repaintP=true)=0;


  virtual void paint(Pose *p=NULL)=0;
  virtual void show()=0;
  virtual void hide()=0;
  virtual void rotate(double angle,bool repaintP=true)=0;
